...
16	"Document Verification"	1	1	"Business registration validated for lease eligibility"	true	"Ijara"	"Islamic Financing Products"	"usertask_risk_credit_analyst"	"ijara_business_registration"
17	"Document Verification"	1	2	"KRA PIN verified and compliant with tax authority"	true	"Ijara"	"Islamic Financing Products"	"usertask_risk_credit_analyst"	"ijara_kra_pin"
18	"Document Verification"	1	3	"Audited financial statements reviewed for lease capacity"	true	"Ijara"	"Islamic Financing Products"	"usertask_risk_credit_analyst"	"ijara_audited_financials"
19	"Document Verification"	1	4	"Leased asset invoice validated — supplier and lease structure confirmed"	true	"Ijara"	"Islamic Financing Products"	"usertask_risk_credit_analyst"	"ijara_asset_invoice"
20	"Document & Agreement Review"	1	1	"Offer letter verified field-by-field against BCC approval — all amounts, tenor, product name and conditions correct"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_offer_letter_check"
21	"Document & Agreement Review"	1	2	"Facility agreement (FA v1.1) reviewed — all RCA conditions in Clauses 18 & 19 confirmed"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_fa_review"
22	"Document & Agreement Review"	1	3	"Wakala Agency Agreement reviewed — bank principal / borrower agent structure confirmed Shariah-compliant"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_wakala_agreement"
23	"Document & Agreement Review"	1	4	"All three documents fully executed and uploaded to Mayan EDMS"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_documents_uploaded"
24	"Collateral & Security Perfection"	2	1	"LRA Form 3 official search received from Machakos County Lands Registry — confirmed clear"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_lra_form3"
25	"Collateral & Security Perfection"	2	2	"Section 79 LRA 2012 charge deed executed — both borrower and DIB authorised officer have signed"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_charge_deed"
26	"Collateral & Security Perfection"	2	3	"Stamp duty paid via KRA eCitizen portal — payment receipt filed in Mayan EDMS"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_stamp_duty"
27	"Collateral & Security Perfection"	2	4	"First charge registered at Machakos County Lands Registry — certificate of charge received and filed in DMS"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_charge_registration"
28	"Insurance"	3	1	"Wakala asset insurance (KES 60M min) — all 5 insurance requirements confirmed · original policy schedule filed"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_asset_insurance"
29	"Insurance"	3	2	"Land and structures insurance (Athi River site) — DIB named as first loss payee · original schedule filed"	true	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_land_insurance"
...
32	"Wakala / Islamic-Specific"	4	1	"Wakala Agency Agreement executed before any instruction to supplier (Alphaline Solutions Ltd) or asset delivery"	false	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_wakala_execution"
33	"Wakala / Islamic-Specific"	4	2	"Supplier payment instruction prepared for Finance stage — Alphaline bank details confirmed"	false	"Ijara"	"Islamic Financing Products"	"usertask_legal_verification"	"ijara_supplier_payment"
34	"Shariah Compliance"	1	1	"Financing structure is Shariah-compliant — no Riba (interest) element"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_shariah_riba_check"
35	"Shariah Compliance"	1	2	"Asset is halal and clearly defined in the application"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_asset_halal"
36	"Shariah Compliance"	1	3	"Ownership confirmed before sale (Murabaha / Wakala requirement)"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_ownership_check"
37	"Shariah Compliance"	1	4	"Cost price and profit disclosed separately — not combined as a single interest rate"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_price_transparency"
38	"Shariah Compliance"	1	5	"No penalty interest clause present in the financing agreement"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_no_penalty_interest"
39	"Shariah Compliance"	1	6	"Customer has been informed of their rights under the contract"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_customer_rights"
40	"Shariah Compliance"	1	7	"All Shariah documentation is complete and attached to this application"	true	"Ijara"	"Islamic Financing Products"	"usertask_shariah_officer"	"ijara_docs_complete"
41	"Conditions Precedent"	1	1	"Executed Murabaha Agreement"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_exec_murabaha"
42	"Conditions Precedent"	1	2	"Vehicle log books endorsed to DIB"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_logbooks_endorsed"
43	"Conditions Precedent"	1	3	"Vehicle charge instruments executed"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_vehicle_charge"
44	"Conditions Precedent"	1	4	"Comprehensive insurance — all 3 units"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_insurance"
45	"Conditions Precedent"	1	5	"Stamp duty payment receipt"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_stamp_duty"
46	"Conditions Precedent"	1	6	"Direct Debit Mandate executed"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_dd_mandate"
47	"Conditions Precedent"	1	7	"NTSA charge notation confirmed"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_ntsa_charge"
48	"Conditions Precedent"	1	8	"Final tax invoice from Isuzu Kenya"	true	"Ijara"	"Islamic Financing Products"	"usertask_disbursement"	"disb_final_invoice"
